...
<body style="background-color: lightgrey;"  onload="setInterval('blink2()',500);" >
	...
	<div id="d2" style="height:550px; width:100%;">
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<h1 id="headline" style="color: white; font-family:italic; font-size:50px;" ><u>Matlab Training in Chidambaram</u></h1><br>
				...
				<div class="col-md-3">
					<div id="logodiv" style="background-color:white; height:450px; width: 400px; margin-top: 50px;">
						<img src="images/matlab.jpg" style="height:250px; width:380px;"><br><br><br>
		...
		<div class="container">
			...
			<div class="row">
			<div class="col-md-12">
				<h1 align="center">Overview of Matlab</h1>
			</div>	
			</div>
			...
			<div class="row">
					...
					<div class="col-md-8">
						<div style="background-color: white;font-size:20px; padding: 20px;"id="overview" >
								<p><b>What is MATLAB?</b><br><br>
								MATLAB is a software package for high-performance mathematical computation, visualization, and programming environment. It provides an interactive environment with hundreds of built-in functions for technical computing, graphics, and animations.<br><br>

								MATLAB stands for Matrix Laboratory. MATLAB was written initially to implement a simple approach to matrix software developed by the LINPACK (Linear system package) and EISPACK (Eigen system package) projects.<br><br>

								MATLAB is a modern programming language environment, and it has refined data structures, includes built-in editing and debugging tools, and supports object-oriented programming.<br><br>

								MATLAB is Multi-paradigm. So, it can work with multiple types of programming approaches, such as Functional, Object-Oriented, and Visual.<br><br>
								Besides an environment, MATLAB is also a programming language.<br><br>
								...
								MATLAB is used in various disciplines of engineering, science, and economics.</p><br>
								MATLAB allows several types of tasks, such as manipulations with matrix, algorithm implementation, data, and functions plotting, and can interact with programs written in other programming languages.<br><br>
								MATLAB is a dynamic and weakly typed programming language.<br><br>

								MATLAB environment handles tasks of the declaration of the data type of the variables and provision for an appropriate amount of storage for the variables.<br><br>

								<b>History of MATLAB</b><br><br>
								...
								<b>Main Features and Capabilities of MATLAB</b><br><br>
								MATLAB's built-in functions provide excellent tools for linear algebra computations, data analysis, signal processing, optimization, numerical solution of ordinary differential equations (ODEs), quadrate, and many other types of scientific calculations.<br><br>

								Most of these functions use state-of-the-art algorithms. These are numerous functions for 2-D and 3-D graphics, as well as for animations.<br><br>

								MATLAB supports an external interface to run those programs from within MATLAB. The user is not limited to the built-in functions; he can write his functions in the MATLAB language.<br><br>

								There are also various optional "toolboxes" available from the developers of MATLAB. These toolboxes are a collection of functions written for primary applications such as symbolic computations, image processing, statistics, control system design, and neural networks.<br><br>

								The necessary building components of MATLAB are the matrix. The fundamental data type is the array. Vectors, scalars, real matrices, and complex matrices are all automatically handled as special cases of the primary data type. MATLAB loves matrices and matrix functions. The built-in functions are optimized for vector functions. Therefore, Vectorized commands or codes run much faster in MATLAB.<br><br>
								<b>MATLAB System</b><br><br>
								The MATLAB systems consist of five main elements:<br><br>
								<b>Development Environment</b><br><br>

								This is the set of tools and facilities that help you use MATLAB operations and files. Many of these tools are the graphical user interface. It involves the MATLAB desktop and command window, a command history, an editor and debugger, and browsers for considering help, the workspace, reports, and the search path.<br><br>
								<b>MATLAB Mathematical Function Library</b><br><br>

								This is a vast compilation of computing design ranging from basic functions, like sum, sine, cosine, and complex mathematic, to more sophisticated features like matrix inverse, matrix eigenvalues, Bessel functions, and fast Fourier transforms.<br><br>

								<b>MATLAB Language</b><br><br>

								This is a high level matrix/array language with control flow statement, function, data structure, input/output, and object-oriented programming characteristics. It allows both "programming in the small" to create quick and dirty throw-away programs rapidly and "programming in the large" to create large and complex application functions.<br><br>

								<b>Graphics</b><br><br>

								MATLAB has extensive facilities for displaying vector and matrices as graphs, as well as annotating and printing these graphs. It contains high-level structures for two-dimensional and three-dimensional data visualization, image processing, animation, and presentation graphics. It also involves low-level structures that allow us to customize the display of graphics fully as well as to build complete graphical user interfaces on our MATLAB applications.<br><br>

								<b>MATLAB External Interfaces/API</b><br><br>
			...
			<div class="row">
				<div class="col-md-12">
					<div align="center" style="background-color: white;"> <br><h1 >Trending courses</h1>
                                        <h3><a href="java.jsp">Java</a><a href="c.jsp">C & C++ </a>| <a href="python.jsp">Python</a> | <a href="dot_net.jsp">.Net</a> | <a href="php.jsp">Php</a> | <a href="advanced_java.jsp">Advanced Java Programming</a> | <a href="j2ee.jsp">J2ee</a> | <a href="advanced_dot_net.jsp">Advanced .Net Programming</a> | <a href="oracle.jsp">Oracle</a> |<a href="web_development.jsp">Fullstack Web Programming</a> | <a href="autocad.jsp">Autocad</a> | <a href="tally.jsp">Tally9</a> | <a href="dtp.jsp">DTP</a> | <a href="ms-office.jsp">MS-Office</a> </h3><br><br></div>
