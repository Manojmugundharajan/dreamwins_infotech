...
<body style="background-color: lightgrey;"  onload="setInterval('blink2()',500);" >
	...
	<div id="d2" style="height:550px; width:100%;">
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<h1 id="headline" style="color: white; font-family:italic; font-size:50px;" ><u>Python Training in Chidambaram</u></h1><br>
				...
				<div class="col-md-3">
					<div id="logodiv" style="background-color:white; height:450px; width: 400px; margin-top: 50px;">
						<img src="images/python.jpg" style="height:250px; width:380px;"><br><br><br>
		...
		<div class="container">
			...
			<div class="row">
			<div class="col-md-12">
				<h1 align="center">Overview of Python</h1>
			</div>	
			</div>
			...
			<div class="row">
					...
					<div class="col-md-8">
						<div style="background-color: white;font-size:20px; padding: 20px;"id="overview" >
							...
							<b>Python is Interpreted −</b> Python is processed at runtime by the interpreter. You do not need to compile your program before executing it. This is similar to PERL and PHP.<br><br>

							<b>Python is Interactive −</b> You can actually sit at a Python prompt and interact with the interpreter directly to write your programs.<br><br>

							<b>Python is Object-Oriented −</b> Python supports Object-Oriented style or technique of programming that encapsulates code within objects.<br><br>

							<b>Python is a Beginner's Language −</b> Python is a great language for the beginner-level programmers and supports the development of a wide range of applications from simple text processing to WWW browsers to games.<br><br>

							<b>History of Python</b><br><br>
							Python was developed by Guido van Rossum in the late eighties and early nineties at the National Research Institute for Mathematics and Computer Science in the Netherlands.<br><br>

							Python is derived from many other languages, including ABC, Modula-3, C, C++, Algol-68, SmallTalk, and Unix shell and other scripting languages.<br><br>

							Python is copyrighted. Like Perl, Python source code is now available under the GNU General Public License (GPL).<br><br>

							Python is now maintained by a core development team at the institute, although Guido van Rossum still holds a vital role in directing its progress.<br><br>

							<b>Python Features</b><br><br>
							Python's features include −<br><br>

							<b>Easy-to-learn −</b> Python has few keywords, simple structure, and a clearly defined syntax. This allows the student to pick up the language quickly.<br><br>

							<b>Easy-to-read −</b> Python code is more clearly defined and visible to the eyes.<br><br>

							<b>Easy-to-maintain −</b> Python's source code is fairly easy-to-maintain.<br><br>

							<b>A broad standard library −</b> Python's bulk of the library is very portable and cross-platform compatible on UNIX, Windows, and Macintosh.<br><br>

							<b>Interactive Mode −</b> Python has support for an interactive mode which allows interactive testing and debugging of snippets of code.<br><br>

							<b>Portable −</b> Python can run on a wide variety of hardware platforms and has the same interface on all platforms.<br><br>

							<b>Extendable −</b> You can add low-level modules to the Python interpreter. These modules enable programmers to add to or customize their tools to be more efficient.<br><br>

							<b>Databases −</b> Python provides interfaces to all major commercial databases.<br><br>

							<b>GUI Programming −</b> Python supports GUI applications that can be created and ported to many system calls, libraries and windows systems, such as Windows MFC, Macintosh, and the X Window system of Unix.<br><br>

							<b>Scalable −</b> Python provides a better structure and support for large programs than shell scripting.<br><br>

							Apart from the above-mentioned features, Python has a big list of good features, few are listed below −<br><br>
							...
							It can be easily integrated with C, C++, COM, ActiveX, CORBA, and Java.<br><br><br>
							...
							-Unix (Solaris, Linux, FreeBSD, AIX, HP/UX, SunOS, IRIX, etc.)<br>
							-Win 9x/NT/2000<br>
							-Macintosh (Intel, PPC, 68K)<br>
							-OS/2<br>
							-DOS (multiple versions)<br>
							-PalmOS<br>
							...
							-VxWorks<br>
							-Psion<br><br>
							Python has also been ported to the Java and .NET virtual machines</p><br>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3><a href="java.jsp">Java </a>| <a href="c.jsp">C & C++</a> | <a href="dot_net.jsp">.Net</a> | <a href="php.jsp">Php</a> | <a href="advanced_java.jsp">Advanced Java Programming</a> | <a href="j2ee.jsp">J2ee</a> | <a href="advanced_dot_net.jsp">Advanced .Net Programming</a> | <a href="oracle.jsp">Oracle</a> |<a href="web_development.jsp">Fullstack Web Programming</a> |<a href="matlab.jsp">Matlab</a> |<a href="autocad.jsp">Autocad</a> | <a href="tally.jsp">Tally9</a> | <a href="dtp.jsp">DTP</a> | <a href="ms-office.jsp">MS-Office</a> </h3><br><br></div>
