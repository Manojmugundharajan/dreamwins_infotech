...
<body style="background-color: lightgrey;"  onload="setInterval('blink2()',500);" >
	...
	<div id="d2" style="height:550px; width:100%;">
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<h1 id="headline" style="color: white; font-family:italic; font-size:50px;" ><u>Autocad Training in Chidambaram</u></h1><br>
				...
				<div class="col-md-3">
					<div id="logodiv" style="background-color:white; height:450px; width: 400px; margin-top: 50px;">
						<img src="images/autocad.jpg" style="height:250px; width:380px;"><br><br><br>
		...
		<div class="container">
			...
			<div class="row">
			<div class="col-md-12">
				<h1 align="center">Overview of Autocad</h1>
			</div>	
			</div>
			...
			<div class="row">
					...
					<div class="col-md-8">
						<div style="background-color: white;font-size:20px; padding: 20px;"id="overview" >
								<p>AutoCAD is a commercial computer-aided design (CAD) and drafting software application. Developed and marketed by Autodesk,[1] AutoCAD was first released in December 1982 as a desktop app running on microcomputers with internal graphics controllers.[2] Before AutoCAD was introduced, most commercial CAD programs ran on mainframe computers or minicomputers, with each CAD operator (user) working at a separate graphics terminal.[3] AutoCAD is also available as mobile and web apps.<br><br>

								AutoCAD is used in industry, by architects, project managers, engineers, graphic designers, city planners and other professionals. It was supported by 750 training centers worldwide in 1994.<br><br>
								<b>Filename extensions</b><br><br>
								AutoCAD's native file formats are denoted either by a .dwg, .dwt, .dws, or .dxf filename extension.<br><br>

								The primary file format for 2D and 3D drawing files created with AutoCAD is .dwg. While other third-party CAD software applications can create .dwg files, AutoCAD uniquely creates RealDWG files.<br><br>

								Using AutoCAD, any .dwg file may be saved to a derivative format. These derivative formats include:<br><br>

								-Drawing Template Files .dwt: New .dwg are created from a .dwt file. Although the default template file is acad.dwt for AutoCAD and acadlt.dwt for AutoCAD LT, custom .dwt files may be created to include foundational configurations such as drawing units and layers.<br><br>
								-Drawing Standards File .dws: Using the CAD Standards feature of AutoCAD, a Drawing Standards File may be associated to any .dwg or .dwt file to enforce graphical standards.<br><br>
								-Drawing Interchange Format .dxf: The .dxf format is an ASCII representation of a .dwg file, and is used to transfer data between various applications.<br><br>
								<b>Compatibility with other software</b><br><br>
								...
								<b>AutoCAD LT</b><br><br>
								AutoCAD LT is the lower-cost version of AutoCAD, with reduced capabilities, first released in November 1993. Autodesk developed AutoCAD LT to have an entry-level CAD package to compete in the lower price level. Priced at $495, it became the first AutoCAD product priced below $1000. It was sold directly by Autodesk and in computer stores unlike the full version of AutoCAD, which must be purchased from official Autodesk dealers. AutoCAD LT 2015 introduced Desktop Subscription service from $360 per year; as of 2018, three subscription plans were available, from $50 a month to a 3-year, $1170 license.<br><br>

								While there are hundreds of small differences between the full AutoCAD package and AutoCAD LT, there are a few recognized major differences[18] in the software's features:<br><br>

								-3D capabilities: AutoCAD LT lacks the ability to create, visualize and render 3D models as well as 3D printing.<br><br>
								-Network licensing: AutoCAD LT cannot be used on multiple machines over a network.<br><br>
								-Customization: AutoCAD LT does not support customization with LISP, ARX, .NET and VBA.<br><br>
								-Management and automation capabilities with Sheet Set Manager and Action Recorder.<br><br>
								-CAD standards management tools.<br>
			...
			<div class="row">
				<div class="col-md-12">
					<div align="center" style="background-color: white;"> <br><h1 >Trending courses</h1>
                                        <h3><a href="java.jsp">Java</a><a href="c.jsp">C & C++ </a>| <a href="python.jsp">Python</a> | <a href="dot_net.jsp">.Net</a> | <a href="php.jsp">Php</a> | <a href="advanced_java.jsp">Advanced Java Programming</a> | <a href="j2ee.jsp">J2ee</a> | <a href="advanced_dot_net.jsp">Advanced .Net Programming</a> | <a href="oracle.jsp">Oracle</a> |<a href="web_development.jsp">Fullstack Web Programming</a> |<a href="matlab.jsp">Matlab</a> | <a href="tally.jsp">Tally9</a> | <a href="dtp.jsp">DTP</a> | <a href="ms-office.jsp">MS-Office</a> </h3><br><br></div>
